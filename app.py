...
def update_planet():
    ...
    if planet:
        ...
        return jsonify(message='No planet exists in the database'), 404
...
def delete_planet(planet_id: int):
    ...
    if planet:
        ...
        return jsonify(message='We could not find your planet'), 404
...
def retrieve_password(email: str):
    ...
    if user:
        msg = Message("your Planetary api user is " + user.password,
